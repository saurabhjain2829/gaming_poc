...
from final_schemas import GameDesignSchema  # ✅ Import from schemas.py
...
print(generate_game_details("As a game designer I want a game on Time travel including storyline, symbols, characters, game msc "))